                ...
                <div class="card-body">
                    <form class="m-t" role="form" method="POST" action="{{route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text"  id="txtTest"  class="form-control @error('first_name') is-invalid @enderror" name="first_name" value="{{ old('first_name') }}"required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <input type="text" id="txtTest1" class="form-control @error('first_name') is-invalid @enderror" name="last_name" value="{{ old('last_name') }}" required>
