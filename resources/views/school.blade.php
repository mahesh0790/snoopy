...
@section('content')
   ...
   <a class="btn btn-info col-md-3 offset-md-8 mb-4" href="/schoolview">Create New
   School Admin</a>
   <table class="table table-bordered table-light">
        ...
        <tbody>
            ...
            <td><h4>{{$school_admin->first_name}}</h4></td>
            <td><a  value="EDIT" class="btn btn-primary" href="/school/{{$school_admin->id}}">Edit</a>
            <button type="button" value="delete" class="btn btn-warning" data-toggle="modal" data-target="#exampleModalCenter" onclick="deleteData({{$school_admin->id}})">Delete</button></td>
           ...
           <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            ...
                            <form action="" id="deleteForm" method="post">
                                ...
                                <div class="modal-header">
                                  <p class="modal-title text-center" id="exampleModalLongTitle"><h3>DELETE SCHOOL ADMIN</h3></p>
